      ...
      >
        ...
        <div className="flex flex-col md:flex-row  gap-5 items-center">
          <img
            ...
            className="w-64 h-64 rounded-lg object-cover border-4 shadow-lg"
          ...
          >
            ...
            <p
              className="text-gray-300 text-sm sm:text-base md:max-w-xl "
              style={{ color: "var(--theme-text-black)" }}
            >
              {personalInfo.bio}
            </p>
            <div className="flex flex-wrap mt-3 justify-center md:justify-start">
              <div
                className="flex items-center gap-1 mr-2 text-sm sm:text-base text-gray-300"
                style={{ color: "var(--theme-text-black)" }}
              >
                <MapPin size={19} />
        ...
        <div
          data-aos="fade-up"
          data-aos-duration="800"
          className="mt-10 border-b border-gray-800 mb-6"
        >
            ...
            <div>
              ...
              {education.map((item, index) => (
                <div key={index} className="border-l-2 pl-4 mb-4">
                  <h4 style={{ color: "var(--theme-text-black)" }}>
                    {item.degree}
                  </h4>
